...
$(function() {
    ...
    option = {
        ...
        xAxis: {
            ...
            axisLine:{
                lineStyle:{
                    color: ArrOw.colors["gray-100"],
                }
            },
            axisLabel: {
                color: ArrOw.colors["gray-700"],
            }
        },
        yAxis: {
            splitLine: {
            ...
            data: [
                {
                    itemStyle:{
                        color: ArrOw.colors['teal'],
                        borderColor: ArrOw.colors['teal'],
                    },
                    value: [20, 30, 10, 35]
                },
                {
                    itemStyle:{
                        color: ArrOw.colors['blue'],
                        color0: ArrOw.colors['blue'],
                        borderColor: ArrOw.colors['blue'],
                        borderColor0: ArrOw.colors['blue'],
                    },
                    value: [40, 35, 30, 55]
                },
                {
                    itemStyle:{
                        color: ArrOw.colors['pink'],
                        borderColor: ArrOw.colors['pink'],
                    },
                    value: [33, 38, 33, 40]
                },
                {
                    itemStyle:{
                        color: ArrOw.colors['orange'],
                        borderColor: ArrOw.colors['orange'],
                    },
                    value: [40, 40, 32, 42]
                },
            ]
        ...
        series: [
            {
                ...
                data:[
                    {value:335, name:'Data1', itemStyle: {color: ArrOw.colors["blue-darkest"],}},
                    {value:310, name:'Data2', itemStyle: {color: ArrOw.colors["blue-dark"],}},
                    {value:234, name:'Data3', itemStyle: {color: ArrOw.colors["blue"],}},
                    {value:135, name:'Data4', itemStyle: {color: ArrOw.colors["blue-light"],}},
                    {value:1548, name:'Data5', itemStyle: {color: ArrOw.colors["blue-lightest"],}}
                ]
            }
        ]
    };
